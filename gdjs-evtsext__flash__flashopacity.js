...
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    ...
    gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("TweenBehavior")).addObjectOpacityTween("__Flash.ToTargetOpacity", eventsFunctionContext.getArgument("TargetOpacity"), "easeInOutCubic", 1000 * eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getHalfPeriodTime(), false);
}
}{for(var i = 0, len = gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    ...
    gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setFlashDuration(eventsFunctionContext.getArgument("FlashDuration"));
}
}{for(var i = 0, len = gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashOpacity.FlashOpacity.prototype.FlashContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setTargetOpacity(eventsFunctionContext.getArgument("TargetOpacity"));
}
}}
